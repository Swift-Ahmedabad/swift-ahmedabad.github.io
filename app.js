...
async function loadContent() {
    try {
        ...
        document.getElementById('community-name').textContent = data.community.name;
        document.getElementById('community-tagline').textContent = data.community.tagline;
        document.getElementById('community-logo').src = data.community.logo;
        document.getElementById('community-logo').alt = data.community.name + ' Logo';
        document.getElementById('navbar-logo-img').src = data.community.logo;
        document.getElementById('navbar-logo-img').alt = data.community.name + ' Logo';
        document.getElementById('contact-btn').href = `mailto:${data.community.email}`;
        document.title = data.community.name;
        
        // Render links
        const container = document.getElementById('links-container');
        container.innerHTML = data.links.map(link => createCard(link)).join('');
